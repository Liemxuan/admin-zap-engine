...
interface TemplateSectionProps {
    ...
    onUpdateConfig?: (newTemplateConfig: TemplateConfig) => void;
...
const TemplateSection: React.FC<TemplateSectionProps> = ({
    ...
    const loginFormConfig = config.templateConfig?.loginForm || {};
    ...
    const templateSections = [
        ...
        { id: 'Login Form', role: 'Organism.LoginForm', icon: CreditCard },
    ];
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto custom-scrollbar bg-gray-50/50 p-8">
                    ...
                    <div className="w-full">
                        ...
                        {/* Login Form */}
                        {activeSection === 'Login Form' && (
                            <ContainerDevWrapper
                                identity={{ displayName: "Organism.LoginForm", type: "Organism", value: "Login Form", filePath: "components/TemplateSection.tsx" }}
                                showClassNames={showClassNames}
                            >
                                <section className="space-y-6">
                                    ...
                                    <div className="p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                        <TemplatePreview
                                            name="Login Form"
                                            data={{ ...loginFormConfig }}
                                            showClassNames={showClassNames}
                                            className="w-full"
                                            stateVar="loginFormConfig"
                                        >
                                            <LoginForm
                                                themeState={themeState}
                                                onSubmit={() => { }}
