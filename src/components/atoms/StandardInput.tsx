            ...
            <div className="relative w-full">
                ...
                {RightIcon && (
                    <div
                        ...
                        className={`absolute right-4 top-1/2 -translate-y-1/2 transition-colors ${onRightIconClick ? 'cursor-pointer active:scale-90 hover:text-gray-600' : 'pointer-events-none'} ${hasError ? 'text-red-500' : 'text-gray-400'}`}
                    >
                        <RightIcon size={18} />
                    </div>
                )}
