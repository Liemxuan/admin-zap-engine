            ...
            <section className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <div className="p-6 bg-gray-50 rounded-xl border border-gray-100 flex flex-wrap gap-4 items-center">
                            <TooltipProvider>
                                <Tooltip>
                                    <TooltipTrigger className="cursor-help">
                                        <div className="px-4 py-2 bg-white border border-gray-200 shadow-sm rounded-lg text-sm font-bold active:scale-95 transition-transform flex gap-2 items-center">
